...
function Transcribing(props) {
    ...
    return (
        <div className='flex items-center flex-1 flex-col justify-center gap-10 md:gap-14 pb-24 text-center p-4'>
            <div className='flex flex-col gap-2 sm:gap-4'>
                <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl lg:text-7xl'><span className='text-blue-400 bold'>Transscribeing</span></h1>
